 const tech = {
    ...
    tech: [{
        ...
        },
        {
            ...
            description: "since nail gun does not work, an upgraded <strong class='color-bot'>bot</strong> fires <strong>nails</strong> at mobs in line of sight. Max count has been updated to 90, and these are much more common now",
            maxCount: 90,
            count: 0,
            frequency: 4,
            frequencyDefault: 1,
        ...
        },
        {
            ...
            description: "Since many players have complained that foam-bot is too weak, a <strong class='color-bot'>bot</strong> fires <strong>foam</strong> at nearby mobs. Max Count has been updated to 9000, and these bots are much more common now",
            maxCount: 9000,
            count: 0,
            frequency: 2,
            frequencyDefault: 2,
        ...
        },
        {
            ...
            description: "a <strong class='color-bot'>bot</strong> uses <strong class='color-f'>energy</strong> to emit a <strong class='color-laser'>laser</strong> beam<br>that targets nearby mobs. Much more common than other bots now.",
            maxCount: 90,
            count: 0,
            frequency: 6,
            frequencyDefault: 6,
        ...
        },
        {
            ...
            effect() {
                ...
                m.setMaxHealth();
                m.addHealth(0.05/ simulation.healScale)
            },
            remove() {
        ...
        },
        {
            ...
            frequencyDefault: 4,
            allowed() {
                return tech.haveGunCheck("Pull Gun") && !tech.isShotgunReversed
            },
            requires: "shotgun, not Noether violation/Reverse Booster",
            effect() {
        ...
        {
            name: "Reverse Booster",
            link: `<a target="_blank" href='https://en.wikipedia.org/wiki/Noether%27s_theorem' class="link">Noether violation</a>`,
            description: "<strong>+50%</strong> <strong>Pull Gun</strong> <strong class='color-d'>damage</strong><br><strong>shotgun</strong> <strong>knockback</strong> is <strong>reversed</strong>. Be sure to be careful, the knockback can be very strong and uncontrollable if not used to.",
            isGunTech: true,
            maxCount: Infinity,
            count: 0,
            frequency: 4,
            frequencyDefault: 4,
            allowed() {
                return (tech.haveGunCheck("Pull Gun")) && !tech.isShotgunRecoil
            },
            requires: "pull gun, not newton's third law",
            effect() {
        ...
        {
            name: "Pull-Gun nail-shot",
            link: `<a target="_blank" href='https://en.wikipedia.org/wiki/Nail_(fastener)' class="link">nail-shot</a>`,
            description: "<strong> Pull- gun</strong> drives a long clip of <strong>nails</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 4,
            frequencyDefault: 4,
            allowed() {
                return tech.haveGunCheck("Pull Gun") && !tech.isIncendiary && !tech.isRivets && !tech.isIceShot && !tech.isFoamShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles
            },
            requires: ", not incendiary, rivets, foam-shot, worm-shot, ice-shot, needles",
            effect() {
        ...
        {
            name: "Pull-Gun foam-shot",
            link: `<a target="_blank" href='https://en.wikipedia.org/wiki/Foam' class="link">foam-shot</a>`,
            description: "<strong>Pull gun</strong> sprays sticky <strong>foam</strong> bubbles",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 4,
            frequencyDefault: 4,
            allowed() {
                return tech.haveGunCheck("Pull Gun") && !tech.isNailShot && !tech.isIncendiary && !tech.isRivets && !tech.isIceShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles
            },
            requires: "pull gun, not incendiary, nail-shot, rivet, worm-shot, ice-shot, needle",
            effect() {
        ...
        {
            name: "Pull Gun ice-shot",
            link: `<a target="_blank" href='https://en.wikipedia.org/wiki/Ice-nine_(disambiguation)' class="link">ice-shot</a>`,
            description: "<strong>Pull Gun</strong> grows freezing <strong class='color-s'>ice IX</strong> crystals",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 4,
            frequencyDefault: 4,
            allowed() {
                return tech.haveGunCheck("Pull Gun") && !tech.isNailShot && !tech.isIncendiary && !tech.isRivets && !tech.isFoamShot && !tech.isSporeWorm && !tech.isSporeFlea && !tech.isNeedles
            },
        ...
        },
        {
            ...
            description: "<strong>Pull Gun</strong>, <strong>rivets</strong>, <strong>super balls</strong>, and <strong>drones</strong><br>are loaded with <strong class='color-e'>explosives</strong>",
            isGunTech: true,
            maxCount: 1,
            count: 0,
            frequency: 4,
